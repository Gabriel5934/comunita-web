...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React3 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState6 = React3.useState, useEffect6 = React3.useEffect, useLayoutEffect3 = React3.useLayoutEffect, useDebugValue = React3.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
function transferMatchResources(router, previous, next, deferSameIdFlight) {
  ...
  for (const match of previous) if (!next?.includes(match)) {
    const flight = match._flight;
    match._flight = void 0;
    if (deferSameIdFlight && flight?.[2] === 1 && router._flights?.get(match.id) === flight && !router._tx?.[6] && next?.some((candidate) => candidate.id === match.id)) flight[2] = 0;
    else {
...
function useIntersectionObserver(ref, callback, intersectionObserverOptions2 = {}, disabled) {
  React$1.useEffect(() => {
...
function useValueStable(value) {
  const ref = React$19.useRef(value);
...
function useLinkProps(options, forwardedRef) {
  ...
  const selectLinkState = React$19.useCallback((location) => {
    const next = router.buildLocation({
      _fromLocation: location,
      ..._options
    });
...
function Matches() {
  ...
  const inner = (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [!(isServer ?? router.isServer) && (0, import_jsx_runtime12.jsx)(Transitioner, { t: React$113.useState()[1] }), (0, import_jsx_runtime12.jsx)(ResolvedSuspense, {
    fallback: pendingElement,
